...
urlpatterns = patterns('',
    ...
    url(r'^kladr/selectbox_demo/', TemplateView.as_view(template_name='kladr/selectbox.html')),
    url(r'^kladr/typehead_demo/', TemplateView.as_view(template_name='kladr/typehead.html')),
